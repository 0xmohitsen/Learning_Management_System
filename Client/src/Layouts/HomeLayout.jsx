            ...
            {!isLoggedIn && (
              <li className="absolute bottom-4 w-[90%]">
                <div className="flex w-full flex-col items-center justify-center">
                  <button className="btn-primary w-full rounded-md bg-blue-500 px-3 py-2 text-[1rem] font-semibold">
                    <Link to="/login">Login</Link>
                  </button>
                  <button className="btn-secondary w-full rounded-md bg-pink-600 px-3 py-2 text-[1rem] font-semibold">
