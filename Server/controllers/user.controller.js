...
export const register = asyncHandler(async (req, res, next) => {
  ...
  const subject = "User registration completed!";
  const textMessage = `
    <div style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px; border-radius: 5px; border: 1px solid #ddd;">
      <h2 style="text-align: center; color: #28a745;">Welcome to LMS!</h2>
      <p style="font-size: 16px; color: #333;">
        Dear ${fullName}, 
      </p>
      <p style="font-size: 16px; color: #333;">
        Thank you for registering with <strong>LMS</strong>. We are excited to have you on board!
      </p>
      <p style="font-size: 16px; color: #333;">
        Get started by exploring our platform and discovering all the amazing features available to you.
      </p>
      <p style="font-size: 16px; color: #333;">
...
export const forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  <div style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px; border-radius: 5px;">
    ...
    <p style="font-size: 16px; color: #333;">
      We received a request to reset your password for your account. To proceed with resetting your password, please click the link below:
    </p>
    <p style="font-size: 16px; color: #333;">
      <a href="${resetPasswordUrl}" target="_blank" style="font-size: 16px; color: #007bff; text-decoration: none;">Reset your password</a>
    </p>
    <p style="font-size: 16px; color: #333;">
      If you are unable to click the link, you can copy and paste the following URL into your browser:
    </p>
    <p style="font-size: 16px; color: #333;">
      ${resetPasswordUrl}
    </p>
